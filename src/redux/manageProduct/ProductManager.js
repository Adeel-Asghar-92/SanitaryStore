...
export const GetProduct = async () => {
  const products = await axios.get("http://52.187.114.144:3000/product");
  return products;
};
...
export const saveChanges = async (product) => {
  ...
  product.id
    ? await axios
        .put(`http://52.187.114.144:3000/product/${product.id}`, product)
        .then((res) => {
          console.log(res);
        })
    : await axios.post("http://52.187.114.144:3000/product", product);
  return product;
};

export const deleteProductById = async (Id) => {
  debugger;
  const id = await axios.delete(`http://52.187.114.144:3000/product/${Id}`);
  return id;
};

export const getProductById = async (ID) => {
  const product = await axios.get(`http://52.187.114.144:3000/product/${ID}`);
  return product;
};
...
export const saveOrder = async (bill) => {
  debugger;
  await axios.post("http://52.187.114.144:3000/orders", bill);
  return bill;
};
...
export const updatedAllItems = async (items) => {
  ...
  if (items.length > 0) {
    await items.forEach((i) => {
      axios.put(`http://52.187.114.144:3000/product/${i.id}`, i);
    });
  }
};
...
export const getHistory = async () => {
  debugger;
  const history = await axios.get(`http://52.187.114.144:3000/orders`);
  return history;
};

export const deleteHistoryById = async (Id) => {
  debugger;
  const id = await axios.delete(`http://52.187.114.144:3000/orders/${Id}`);
  return id;
};
